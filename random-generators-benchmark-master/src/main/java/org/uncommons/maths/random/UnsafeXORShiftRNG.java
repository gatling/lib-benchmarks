 ...
 * as the {@link org.uncommons.maths.random.MersenneTwisterRNG} but it is faster.</p>
 *
...
public class UnsafeXORShiftRNG extends Random implements RepeatableRNG
{
   ...
   * @throws org.uncommons.maths.random.SeedException If there is a problem generating a seed.
   */
