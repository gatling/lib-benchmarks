 ...
 */
public class UnsafeCellularAutomatonRNG extends Random implements RepeatableRNG
{
   ...
   */
  public UnsafeCellularAutomatonRNG()
  {
   ...
   */
  public UnsafeCellularAutomatonRNG(SeedGenerator seedGenerator) throws SeedException
  {
   ...
   */
  public UnsafeCellularAutomatonRNG(byte[] seed)
  {
