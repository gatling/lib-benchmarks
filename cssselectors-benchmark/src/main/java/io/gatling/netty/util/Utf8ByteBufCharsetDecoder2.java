...
public class Utf8ByteBufCharsetDecoder2 {
  ...
  private static final ThreadLocal<Utf8ByteBufCharsetDecoder2> POOL = ThreadLocal.withInitial(Utf8ByteBufCharsetDecoder2::new);
  ...
  private static Utf8ByteBufCharsetDecoder2 pooledDecoder() {
    Utf8ByteBufCharsetDecoder2 decoder = POOL.get();
    decoder.reset();
    return decoder;
  }
  ...
  public static CharBuffer foo(ByteBuf... bufs) {
    return pooledDecoder().decodeHeap0(bufs);
  }
  ...
  public CharBuffer decodeHeap0(ByteBuf[] bufs) {
