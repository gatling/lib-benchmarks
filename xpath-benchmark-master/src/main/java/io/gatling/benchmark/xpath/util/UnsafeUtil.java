...
public final class UnsafeUtil {
    ...
    public static CharSequence newFastCharSequence(String string) {
        ...
        if (UNSAFE != null) {
            ...
            if (STRING_OFFSET_FIELD_OFFSET != -1) {
                ...
                return new FastCharSequence(value, offset, count);

            } else {
                return new FastCharSequence(value);
            }
  ...
  public static Reader newFastCharArrayReader(String string) {
    if (UNSAFE != null) {
      char[] value = (char[]) UNSAFE.getObject(string, STRING_VALUE_FIELD_OFFSET);
      ...
      if (STRING_OFFSET_FIELD_OFFSET != -1) {
        ...
        return new FastCharArrayReader(value, offset, count);

      } else {
        return new FastCharArrayReader(value);
      }
