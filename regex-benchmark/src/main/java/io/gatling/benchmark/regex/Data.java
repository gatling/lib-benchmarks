...
public class Data {
  ...
  public static final Pattern PAGE2_PATTERN = Pattern.compile("<input type=\"hidden\" name=\"_privacyPolicyAccepted\" value=\"(.+?)\"/>");
  ...
  public static final com.google.re2j.Pattern RE2J_PAGE2_PATTERN = com.google.re2j.Pattern.compile("<input type=\"hidden\" name=\"_privacyPolicyAccepted\" value=\"(.+?)\"/>");
